...
@interface SharedApiException : SharedKotlinThrowable
- (instancetype)initWithErrorMessage:(NSString * _Nullable)errorMessage error:(SharedKotlinThrowable * _Nullable)error responseBody:(SharedErrorDto * _Nullable)responseBody __attribute__((swift_name("init(errorMessage:error:responseBody:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) SharedErrorDto * _Nullable responseBody __attribute__((swift_name("responseBody")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppData")))
@interface SharedAppData : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthClientConfig")))
@interface SharedAuthClientConfig : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedKtor_client_coreHttpClient *)createApiGeeHttpClientHttpClientEngine:(id<SharedKtor_client_coreHttpClientEngine>)httpClientEngine log:(SharedKermitLogger *)log __attribute__((swift_name("createApiGeeHttpClient(httpClientEngine:log:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthPluginConfig")))
@interface SharedAuthPluginConfig : SharedBase <SharedKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) SharedAppData *appData __attribute__((swift_name("appData")));
@property (readonly) id<SharedPaymentsRepository> repository __attribute__((swift_name("repository")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BuildKonfig")))
@interface SharedBuildKonfig : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)buildKonfig __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBuildKonfig *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *FLAVOR __attribute__((swift_name("FLAVOR")));
@property (readonly) NSString *HOST __attribute__((swift_name("HOST")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentClientConfig")))
@interface SharedPaymentClientConfig : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedKtor_client_coreHttpClient *)createPrepaidHttpClientHttpClientEngine:(id<SharedKtor_client_coreHttpClientEngine>)httpClientEngine log:(SharedKermitLogger *)log __attribute__((swift_name("createPrepaidHttpClient(httpClientEngine:log:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RequestConfig")))
@interface SharedRequestConfig<T> : SharedBase
- (instancetype)initWithUrlPath:(NSString *)urlPath resource:(id _Nullable)resource postBodyJson:(T _Nullable)postBodyJson headerMap:(NSDictionary<NSString *, NSString *> *)headerMap postBody:(NSDictionary<NSString *, NSString *> *)postBody __attribute__((swift_name("init(urlPath:resource:postBodyJson:headerMap:postBody:)"))) __attribute__((objc_designated_initializer));
- (SharedRequestConfig<T> *)doCopyUrlPath:(NSString *)urlPath resource:(id _Nullable)resource postBodyJson:(T _Nullable)postBodyJson headerMap:(NSDictionary<NSString *, NSString *> *)headerMap postBody:(NSDictionary<NSString *, NSString *> *)postBody __attribute__((swift_name("doCopy(urlPath:resource:postBodyJson:headerMap:postBody:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSDictionary<NSString *, NSString *> *headerMap __attribute__((swift_name("headerMap")));
@property (readonly) NSDictionary<NSString *, NSString *> *postBody __attribute__((swift_name("postBody")));
@property (readonly) T _Nullable postBodyJson __attribute__((swift_name("postBodyJson")));
@property (readonly) id _Nullable resource __attribute__((swift_name("resource")));
@property (readonly) NSString *urlPath __attribute__((swift_name("urlPath")));
@end
...
__attribute__((swift_name("PaymentsRepository")))
@protocol SharedPaymentsRepository
@required
...
*/
- (void)authenticateConfig:(SharedRequestConfig<SharedAuthenticateRequest *> *)config completionHandler:(void (^)(SharedResult<SharedAuthenticateResponse *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("authenticate(config:completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentsRepositoryImpl")))
@interface SharedPaymentsRepositoryImpl : SharedBase <SharedPaymentsRepository>
- (instancetype)initWithHttpClient:(SharedKtor_client_coreHttpClient *)httpClient authClient:(SharedKtor_client_coreHttpClient *)authClient __attribute__((swift_name("init(httpClient:authClient:)"))) __attribute__((objc_designated_initializer));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthenticateRequest")))
@interface SharedAuthenticateRequest : SharedBase
- (instancetype)initWithGrant_type:(NSString *)grant_type __attribute__((swift_name("init(grant_type:)"))) __attribute__((objc_designated_initializer));
- (SharedAuthenticateRequest *)doCopyGrant_type:(NSString *)grant_type __attribute__((swift_name("doCopy(grant_type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) NSString *grant_type __attribute__((swift_name("grant_type")));
@end

__attribute__((swift_name("ApiGeeInteractor")))
@protocol SharedApiGeeInteractor
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiGeeInteractorImpl")))
@interface SharedApiGeeInteractorImpl : SharedBase <SharedApiGeeInteractor>
- (instancetype)initWithAppData:(SharedAppData *)appData repository:(id<SharedPaymentsRepository>)repository __attribute__((swift_name("init(appData:repository:)"))) __attribute__((objc_designated_initializer));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthenticateResponse")))
@interface SharedAuthenticateResponse : SharedBase
- (instancetype)initWithAccessToken:(NSString *)accessToken clientId:(NSString *)clientId expiresIn:(NSString *)expiresIn issuedAt:(NSString *)issuedAt refreshCount:(NSString *)refreshCount refreshTokenExpiresIn:(NSString *)refreshTokenExpiresIn scope:(NSString *)scope status:(NSString *)status tokenType:(NSString *)tokenType __attribute__((swift_name("init(accessToken:clientId:expiresIn:issuedAt:refreshCount:refreshTokenExpiresIn:scope:status:tokenType:)"))) __attribute__((objc_designated_initializer));
- (SharedAuthenticateResponse *)doCopyAccessToken:(NSString *)accessToken clientId:(NSString *)clientId expiresIn:(NSString *)expiresIn issuedAt:(NSString *)issuedAt refreshCount:(NSString *)refreshCount refreshTokenExpiresIn:(NSString *)refreshTokenExpiresIn scope:(NSString *)scope status:(NSString *)status tokenType:(NSString *)tokenType __attribute__((swift_name("doCopy(accessToken:clientId:expiresIn:issuedAt:refreshCount:refreshTokenExpiresIn:scope:status:tokenType:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="issued_at")
*/
@property (readonly) NSString *issuedAt __attribute__((swift_name("issuedAt")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="refresh_count")
*/
@property (readonly) NSString *refreshCount __attribute__((swift_name("refreshCount")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="refresh_token_expires_in")
*/
@property (readonly) NSString *refreshTokenExpiresIn __attribute__((swift_name("refreshTokenExpiresIn")));
...
@interface SharedErrorDto : SharedBase
- (instancetype)initWithTimestamp:(NSString *)timestamp status:(NSString *)status title:(NSString *)title type:(NSString *)type detail:(NSString *)detail instance:(NSString *)instance fault:(NSString *)fault __attribute__((swift_name("init(timestamp:status:title:type:detail:instance:fault:)"))) __attribute__((objc_designated_initializer));
- (SharedErrorDto *)doCopyTimestamp:(NSString *)timestamp status:(NSString *)status title:(NSString *)title type:(NSString *)type detail:(NSString *)detail instance:(NSString *)instance fault:(NSString *)fault __attribute__((swift_name("doCopy(timestamp:status:title:type:detail:instance:fault:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *detail __attribute__((swift_name("detail")));
@property (readonly) NSString *fault __attribute__((swift_name("fault")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteException")))
@interface SharedRemoteException : SharedKotlinException
- (instancetype)initWithType:(SharedRemoteExceptionType *)type __attribute__((swift_name("init(type:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithCause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (instancetype)initWithMessage:(NSString * _Nullable)message cause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (readonly) SharedRemoteExceptionType *type __attribute__((swift_name("type")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RemoteExceptionType")))
@interface SharedRemoteExceptionType : SharedKotlinEnum<SharedRemoteExceptionType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedRemoteExceptionType *serverError __attribute__((swift_name("serverError")));
@property (class, readonly) SharedRemoteExceptionType *clientError __attribute__((swift_name("clientError")));
@property (class, readonly) SharedRemoteExceptionType *parsingError __attribute__((swift_name("parsingError")));
@property (class, readonly) SharedRemoteExceptionType *unknown __attribute__((swift_name("unknown")));
+ (SharedKotlinArray<SharedRemoteExceptionType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<SharedRemoteExceptionType *> *entries __attribute__((swift_name("entries")));
@end

@interface SharedResult (Extensions)
- (SharedResult<id> *)onFailureAction:(void (^)(SharedKotlinThrowable *))action __attribute__((swift_name("onFailure(action:)")));
- (SharedResult<id> *)onSuccessAction:(void (^)(id))action __attribute__((swift_name("onSuccess(action:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthClientKt")))
@interface SharedAuthClientKt : SharedBase
@property (class, readonly) id<SharedKtor_client_coreClientPlugin> AuthPlugin __attribute__((swift_name("AuthPlugin")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentClientKt")))
@interface SharedPaymentClientKt : SharedBase
@property (class, readonly) NSDictionary<NSString *, NSSet<NSString *> *> *productionPinsMap __attribute__((swift_name("productionPinsMap")));
@property (class, readonly) NSDictionary<NSString *, NSSet<NSString *> *> *uatPinsMap __attribute__((swift_name("uatPinsMap")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentKoinModuleKt")))
@interface SharedPaymentKoinModuleKt : SharedBase
...
@property (class, readonly) SharedKermitLogger *baseLogger __attribute__((swift_name("baseLogger")));
@property (class, readonly) SharedKoin_coreModule *prepaidDataModule __attribute__((swift_name("prepaidDataModule")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentsRepositoryKt")))
@interface SharedPaymentsRepositoryKt : SharedBase
+ (void)addMapHeaderMap:(NSDictionary<NSString *, NSString *> *)headerMap __attribute__((swift_name("addMap(headerMap:)")));
+ (NSDictionary<NSString *, NSString *> *)defaultMap __attribute__((swift_name("defaultMap()")));
@end
...
@interface SharedKermit_coreBaseLogger : SharedBase
- (instancetype)initWithConfig:(id<SharedKermit_coreLoggerConfig>)config __attribute__((swift_name("init(config:)"))) __attribute__((objc_designated_initializer));
- (void)logSeverity:(SharedKermit_coreSeverity *)severity tag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable message:(NSString *)message __attribute__((swift_name("log(severity:tag:throwable:message:)")));
- (void)logBlockSeverity:(SharedKermit_coreSeverity *)severity tag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("logBlock(severity:tag:throwable:message:)")));
- (void)processLogSeverity:(SharedKermit_coreSeverity *)severity tag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable message:(NSString *)message __attribute__((swift_name("processLog(severity:tag:throwable:message:)")));
@property (readonly) id<SharedKermit_coreLoggerConfig> config __attribute__((swift_name("config")));
@property (readonly) id<SharedKermit_coreMutableLoggerConfig> mutableConfig __attribute__((swift_name("mutableConfig")));
@end

__attribute__((swift_name("KermitLogger")))
@interface SharedKermitLogger : SharedKermit_coreBaseLogger
- (instancetype)initWithConfig:(id<SharedKermit_coreLoggerConfig>)config tag:(NSString *)tag __attribute__((swift_name("init(config:tag:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithConfig:(id<SharedKermit_coreLoggerConfig>)config __attribute__((swift_name("init(config:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
*/
- (void)aMessageString:(NSString *)messageString throwable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag __attribute__((swift_name("a(messageString:throwable:tag:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)aThrowable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag message:(NSString *(^)(void))message __attribute__((swift_name("a(throwable:tag:message:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)dMessageString:(NSString *)messageString throwable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag __attribute__((swift_name("d(messageString:throwable:tag:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)dThrowable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag message:(NSString *(^)(void))message __attribute__((swift_name("d(throwable:tag:message:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)eMessageString:(NSString *)messageString throwable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag __attribute__((swift_name("e(messageString:throwable:tag:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)eThrowable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag message:(NSString *(^)(void))message __attribute__((swift_name("e(throwable:tag:message:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)iMessageString:(NSString *)messageString throwable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag __attribute__((swift_name("i(messageString:throwable:tag:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)iThrowable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag message:(NSString *(^)(void))message __attribute__((swift_name("i(throwable:tag:message:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)vMessageString:(NSString *)messageString throwable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag __attribute__((swift_name("v(messageString:throwable:tag:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)vThrowable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag message:(NSString *(^)(void))message __attribute__((swift_name("v(throwable:tag:message:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)wMessageString:(NSString *)messageString throwable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag __attribute__((swift_name("w(messageString:throwable:tag:)")));

/**
 * @note annotations
 *   kotlin.jvm.JvmOverloads
*/
- (void)wThrowable:(SharedKotlinThrowable * _Nullable)throwable tag:(NSString *)tag message:(NSString *(^)(void))message __attribute__((swift_name("w(throwable:tag:message:)")));
...
@protocol SharedKermit_coreLoggerConfig
@required
@property (readonly) NSArray<SharedKermit_coreLogWriter *> *logWriterList __attribute__((swift_name("logWriterList")));
@property (readonly) SharedKermit_coreSeverity *minSeverity __attribute__((swift_name("minSeverity")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kermit_coreSeverity")))
@interface SharedKermit_coreSeverity : SharedKotlinEnum<SharedKermit_coreSeverity *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedKermit_coreSeverity *verbose __attribute__((swift_name("verbose")));
@property (class, readonly) SharedKermit_coreSeverity *debug __attribute__((swift_name("debug")));
@property (class, readonly) SharedKermit_coreSeverity *info __attribute__((swift_name("info")));
@property (class, readonly) SharedKermit_coreSeverity *warn __attribute__((swift_name("warn")));
@property (class, readonly) SharedKermit_coreSeverity *error __attribute__((swift_name("error")));
@property (class, readonly) SharedKermit_coreSeverity *assert __attribute__((swift_name("assert")));
+ (SharedKotlinArray<SharedKermit_coreSeverity *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<SharedKermit_coreSeverity *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((swift_name("Kermit_coreMutableLoggerConfig")))
@protocol SharedKermit_coreMutableLoggerConfig <SharedKermit_coreLoggerConfig>
@required
- (void)setLogWriterList:(NSArray<SharedKermit_coreLogWriter *> *)value __attribute__((swift_name("setLogWriterList(_:)")));
- (void)setMinSeverity:(SharedKermit_coreSeverity *)value __attribute__((swift_name("setMinSeverity(_:)")));
@end
...
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithConfig:(id<SharedKermit_coreLoggerConfig>)config tag:(NSString *)tag __attribute__((swift_name("init(config:tag:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKermitLoggerCompanion *shared __attribute__((swift_name("shared")));
- (void)aTag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable message:(NSString *(^)(void))message __attribute__((swift_name("a(tag:throwable:message:)")));
- (void)addLogWriterLogWriter:(SharedKotlinArray<SharedKermit_coreLogWriter *> *)logWriter __attribute__((swift_name("addLogWriter(logWriter:)")));
...
- (void)setLogWritersLogWriter:(SharedKotlinArray<SharedKermit_coreLogWriter *> *)logWriter __attribute__((swift_name("setLogWriters(logWriter:)")));
- (void)setLogWritersLogWriters:(NSArray<SharedKermit_coreLogWriter *> *)logWriters __attribute__((swift_name("setLogWriters(logWriters:)")));
- (void)setMinSeveritySeverity:(SharedKermit_coreSeverity *)severity __attribute__((swift_name("setMinSeverity(severity:)")));
...
@interface SharedKermit_coreLogWriter : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (BOOL)isLoggableTag:(NSString *)tag severity:(SharedKermit_coreSeverity *)severity __attribute__((swift_name("isLoggable(tag:severity:)")));
- (void)logSeverity:(SharedKermit_coreSeverity *)severity message:(NSString *)message tag:(NSString *)tag throwable:(SharedKotlinThrowable * _Nullable)throwable __attribute__((swift_name("log(severity:message:tag:throwable:)")));
@end
